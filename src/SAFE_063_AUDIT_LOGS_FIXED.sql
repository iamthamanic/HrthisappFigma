-- =====================================================================================
-- SAFE MIGRATION 063: UNIVERSAL AUDIT LOG SYSTEM (FIXED VERSION)
-- =====================================================================================
-- Description: Nur die Kern-Infrastruktur OHNE Trigger auf fehlende Tabellen
-- Version: 1.0.1 FIXED (Teamlead RLS Policy korrigiert)
-- Date: 2025-10-17
-- =====================================================================================
...
-- Teamleads können Logs ihrer Team-Mitglieder sehen (FIXED)
...
CREATE POLICY "Teamleads can view their team members audit logs"
  ...
  USING (
    ...
    AND EXISTS (
      ...
      AND tm1.role = 'teamlead'
      AND tm2.user_id = affected_user_id
    )
  );
...
-- =====================================================================================
-- ✅ MIGRATION 063 COMPLETE (FIXED VERSION)
-- =====================================================================================

COMMENT ON TABLE audit_logs IS 'v1.0.1 FIXED - Universal Audit Log System (Teamlead RLS korrigiert)';
