...
-- =====================================================
-- Created: 2025-01-12
-- Purpose: Dashboard announcements with rich content and push-to-live system
-- Only ONE announcement can be live at a time per organization
...
-- Ensure only ONE announcement is live per organization
...
-- Function: Auto-track live history
...
-- Function: Auto-unpublish other announcements when one goes live
...
-- 2. Create admin screen for managing announcements
-- 3. Add announcement display to dashboard
