/**
 * Wiki Full-Text Search Migration - SAFE VERSION
 * Version: v4.12.22
 * 
 * SAFE VERSION: Drops existing function first to avoid conflicts
 * 
...
-- =====================================================================================
-- 0. DROP EXISTING FUNCTION (if exists)
-- =====================================================================================

-- Drop the old function first to avoid "cannot change return type" error
