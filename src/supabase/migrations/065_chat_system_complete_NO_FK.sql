-- ============================================================================
-- BROWO KOORDINATOR - CHAT SYSTEM COMPLETE (NO FOREIGN KEYS VERSION)
-- ============================================================================
-- This version uses UUID fields WITHOUT foreign key constraints to auth.users
...
CREATE INDEX IF NOT EXISTS idx_conversations_created_by ON BrowoKo_conversations(created_by);
...
CREATE INDEX IF NOT EXISTS idx_message_reactions_user ON BrowoKo_message_reactions(user_id);
...
CREATE INDEX IF NOT EXISTS idx_typing_indicators_user ON BrowoKo_typing_indicators(user_id);
...
CREATE TABLE IF NOT EXISTS BrowoKo_user_status (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  user_id UUID UNIQUE NOT NULL, -- No FK constraint
...
CREATE TABLE IF NOT EXISTS BrowoKo_knowledge_articles (
  ...
  title TEXT NOT NULL,
  content TEXT NOT NULL,
  author_id UUID, -- No FK constraint
  tags TEXT[],
