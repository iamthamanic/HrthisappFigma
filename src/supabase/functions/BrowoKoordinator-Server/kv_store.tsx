...
/* Table schema:
CREATE TABLE kv_store_f659121d (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/azmtojgikubegzusvhra/database/tables
...
export const set = async (key: string, value: any): Promise<void> => {
  ...
  const { error } = await supabase.from("kv_store_f659121d").upsert({
    key,
    value
  });
  if (error) {
