# 📦 DEPLOYMENT VIA SUPABASE DASHBOARD: ZEITERFASSUNG v2.1.0

## ✅ **DATEI IST READY!**

Die Datei `/supabase/functions/BrowoKoordinator-Zeiterfassung/index.ts` wurde vollständig aktualisiert mit:
- ✅ Version **2.1.0**
- ✅ Alle `clock_in` → `start_time`
- ✅ Alle `clock_out` → `end_time`

---

## **📋 DEPLOYMENT ÜBER SUPABASE DASHBOARD**

### **SCHRITT 1: ÖFFNE SUPABASE DASHBOARD**

1. Gehe zu: https://supabase.com/dashboard/project/azmtojgikubegzusvhra
2. Login mit deinem Account
3. Navigiere zu: **Edge Functions** (linke Sidebar)

---

### **SCHRITT 2: FUNCTION FINDEN**

1. Suche nach: **`BrowoKoordinator-Zeiterfassung`**
...
#### **Option A: Über Editor**
1. Klicke auf **"Edit Function"** oder **"Code"** Tab
2. **Lösche den kompletten alten Code**
3. **Kopiere den neuen Code** (siehe unten)
4. **Speichern** ("Save" Button)

#### **Option B: Über "Deploy"**
1. Klicke auf **"Deploy new version"**
2. Wähle **"Upload code"** oder **"Paste code"**
3. Füge den Code ein
4. Deploy

---

### **SCHRITT 4: CODE KOPIEREN (KOMPLETTE DATEI)**
 ...
 * 
 * @version 2.1.0 - Schema migration fix (clock_in/out → start_time/end_time)
 */
...
**⚠️ WICHTIG:** Nach dem Deploy im Dashboard:

1. **JWT Verification DEAKTIVIEREN:**
   - Suche nach: **"Enforce JWT verification"** oder **"Require authentication"**
   - **DEAKTIVIERE** diese Option
   - **Grund:** `/health` Endpoint muss public sein für Monitoring

ODER verwende diese Einstellung:
- **"Allow anonymous access to /health"** → **AKTIVIERT**

---

### **SCHRITT 6: DEPLOYMENT BESTÄTIGEN**

Nach dem Deploy teste den Health Endpoint:
...
Öffne https://item-alike-38235473.figma.site und führe die Tests aus (siehe `/ZEITERFASSUNG_WRITE_TESTS.md`)

---

## **📝 ZUSAMMENFASSUNG**

- ✅ Code ist in `/supabase/functions/BrowoKoordinator-Zeiterfassung/index.ts`
- ✅ Version: **2.1.0**
- ✅ Schema-Fix: `clock_in/out` → `start_time/end_time`
- ✅ Deploy über Dashboard (Code oben kopieren)
- ⚠️ JWT Verification für `/health` deaktivieren
- ✅ Health Check testen
- ✅ Write-Tests durchführen
