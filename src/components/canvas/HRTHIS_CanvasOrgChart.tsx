...
import { Pencil, Trash2 } from '../icons/HRTHISIcons';
...
import CanvasControls from './HRTHIS_CanvasControls';
import { getPinPosition, getConnectedPins, getPinsConnectedToSelectedNode, calculateFitToScreen } from './HRTHIS_CanvasUtils';
import {
 ...
 * 
 * Architecture:
 * - HRTHIS_CanvasTypes.ts: TypeScript interfaces
 * - HRTHIS_CanvasUtils.ts: Helper functions
 * - HRTHIS_CanvasHandlers.ts: Event handlers
 * - HRTHIS_CanvasControls.tsx: UI controls
 * - HRTHIS_CanvasOrgChart.tsx: Main component (this file)
 */
...
export type { CanvasOrgChartHandle, CanvasOrgChartProps } from './HRTHIS_CanvasTypes';
export type { Connection } from './HRTHIS_CanvasTypes';
