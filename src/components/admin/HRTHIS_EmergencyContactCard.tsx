/**
 * @file HRTHIS_EmergencyContactCard.tsx (Admin Version)
 * @version v4.8.0 - Card-Level Editing
 * @description Emergency contacts card with individual edit button for ADMIN
 */
...
import { Phone, Edit, X, Save, Plus, Trash2 } from '../icons/HRTHISIcons';
...
export function EmergencyContactCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated }: EmergencyContactCardProps) {
