/**
 * @file BrowoKo_AddressCard.tsx (Admin Version)
 * @version v4.8.0 - Card-Level Editing
 * @description Address card with individual edit button for ADMIN
 */
...
import { MapPin, Edit, X, Save } from '../icons/BrowoKoIcons';
...
export function AddressCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated }: AddressCardProps) {
