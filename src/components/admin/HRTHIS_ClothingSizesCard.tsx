/**
 * @file HRTHIS_ClothingSizesCard.tsx (Admin Version)
 * @version v4.8.0 - Card-Level Editing
 * @description Clothing sizes card with individual edit button for ADMIN
 */
...
import { Package, Edit, X, Save } from '../icons/HRTHISIcons';
...
export function ClothingSizesCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated }: ClothingSizesCardProps) {
