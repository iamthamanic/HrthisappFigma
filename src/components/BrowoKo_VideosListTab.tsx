/**
 * @file BrowoKo_VideosListTab.tsx
 * @domain HR - Learning Management
 * @description Complete videos list tab with category filter and list
 * @namespace BrowoKo_
 */

import { Video } from './icons/BrowoKoIcons';
import { Card, CardContent, CardHeader, CardTitle } from './ui/card';
import VideoCategoryFilter from './BrowoKo_VideoCategoryFilter';
import VideoListItem from './BrowoKo_VideoListItem';
