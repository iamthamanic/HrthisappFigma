...
import { Megaphone, ExternalLink, Video, Gift, X } from './icons/HRTHISIcons';
import { formatDistanceToNow } from 'date-fns';
import { de } from 'date-fns/locale';
import type { Announcement, AnnouncementContentBlock } from '../services/HRTHIS_announcementService';
