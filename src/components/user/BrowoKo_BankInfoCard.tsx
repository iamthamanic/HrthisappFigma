/**
 * @file BrowoKo_BankInfoCard.tsx
 * @version v4.8.0
 * @description Bank Info Card with card-level editing for MeineDaten
...
export function BankInfoCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated, permissions }: BankInfoCardProps) {
    ...
    <Card>
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {!isEditing && permissions.canEditBankInfo && (
            <TooltipProvider>
              <Tooltip>
