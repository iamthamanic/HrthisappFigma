/**
 * @file BrowoKo_PersonalDataCard.tsx
 * @version v4.8.0
 * @description Personal Data Card with card-level editing for MeineDaten
...
import { Edit, X, Save } from '../icons/BrowoKoIcons';
...
export function PersonalDataCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated, permissions }: PersonalDataCardProps) {
    ...
    <Card>
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {!isEditing && permissions.canEditPersonalInfo && (
            <TooltipProvider>
              <Tooltip>
