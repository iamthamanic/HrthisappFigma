/**
 * @file HRTHIS_LanguageSkillsCard.tsx
 * @version v4.8.0
 * @description Language Skills Card with card-level editing
 */
...
import { Globe, Edit, X, Save, Plus, Trash2 } from '../icons/HRTHISIcons';
...
export function LanguageSkillsCard({ user, canEdit, onEditStart, onEditEnd, onDataUpdated, permissions }: LanguageSkillsCardProps) {
    ...
    <Card>
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {!isEditing && permissions.canEditLanguageSkills && (
            <TooltipProvider>
              <Tooltip>
