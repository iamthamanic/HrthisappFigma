/**
 * @file BrowoKo_DashboardOrganigramCard.tsx
 * @domain HR - Dashboard
 * @description Collapsible organigram card for dashboard
 * @created Phase 2.2 - Priority 4 Refactoring
 */

import { Network, ChevronDown, ChevronUp } from './icons/BrowoKoIcons';
import { Card, CardContent, CardHeader, CardTitle } from './ui/card';
import { Button } from './ui/button';
import { Alert, AlertDescription } from './ui/alert';
import CanvasOrgChart, { type Connection } from './canvas/BrowoKo_CanvasOrgChart';
